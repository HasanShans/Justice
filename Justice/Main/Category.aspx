<%@ Page Title="" Language="C#" MasterPageFile="~/Main/Site.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="Justice.Main.Category" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section style="min-height: 352px;" id="products">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="pagination">
                        <a href='http://192.168.5.22/category.php?cat=".$cat."&s={$i}' class='active'></a>
                    </div>
                </div>
            </div>
        </div>

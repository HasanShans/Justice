<%@ Page Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="Justice.ChangePassword" Title="Yeni Şifrə"%>
                    ...
                    <div class="register">
                        ...
                        <div class='form-group row'>
                            ...
                            <div class='col-sm-9'>
                                ...
                                <asp:RegularExpressionValidator Display = "Dynamic" ControlToValidate = "txtNewPass" ID="RegularExpressionValidator3" ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d!$%@#£€*?&]{8,}$" runat="server" ErrorMessage="Şifrədə hərflər və rəqəmlər olmaqla yanaşı uzunluğu 8 simvol olmalıdır" SetFocusOnError="true"></asp:RegularExpressionValidator>
                            </div>
                        </div>
                        <div class='form-group row'>

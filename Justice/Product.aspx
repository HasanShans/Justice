<%@ Page Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Justice.Product" Title="Məhsul"%>
        ...
        <div class="container">
            <div class="row">
                <div class='col-md-12'>
                    <div class='title'>
                        <h3>
                            <a href='ana-səhifə'>Ana Səhifə</a>
                            <i class='fa fa-arrow-right' aria-hidden='true'></i>
                            <a href='ana-səhifə?kateqoriya=<%= data["mehsul_kateqoriya"]%>'><%= data["mehsul_kateqoriya"] %></a>
                            <i class='fa fa-arrow-right' aria-hidden='true'></i>
                            <%= data["mehsul_ad"] %>
                        </h3>
                    </div>
                    ...
                    <div class='product_single_about'>
                        <table class='table table-striped table-responsive'>
                            <tbody>
                                ...
                                <tr>
                                    <td>Hazırlandığı həbsxana</td>
                                    <td><%= data["mehsul_hebsxana"] %></td>
                                </tr>
                                <tr>

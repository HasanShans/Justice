<%@ Page Title="Həbsxana İncəsənəti" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Justice.Index" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <section id="show_case">
        <div class="container">
            <div class="row">
                <div class="col-md-6" runat="server" id="mostSoldProducts">
                    <div class="best_seller">
                        <div class="title">
                            <h3 class="text-left">Ən çox satılan</h3>
                            <p class="text-right"><a href="məhsul-filter?filter=MostSoldProducts">Hamısını göstər</a></p>
                        </div>
                ...
                <div class="col-md-6" runat="server" id="newProducts">
                    <div class="new_product">
                        <div class="title">
                            <h3 class="text-left">Yeni məhsullar</h3>
                            <p class="text-right"><a href="məhsul-filter?filter=NewProducts">Hamısını göstər</a></p>
                        </div>
                        <div class='row title_content'>
                            <div class='col-md-5'>

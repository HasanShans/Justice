<%@ Page Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="Orders.aspx.cs" Inherits="Justice.Orders" Title="Sifarişlər" %>
                            ...
                            <asp:Repeater ID="rprtOrders" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td> <%# ((Int64)Eval("PaymentStatusID") == 1) ? "Ödənilib" : "Ləğv edilib" %></td>

...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <asp:HyperLink runat="server" CssClass="btn btn-success" Style="margin:10px;" ID="test2" NavigateUrl="~/root/yeni-kateqoriya" Text="Kateqoriya əlavə et"></asp:HyperLink>
                    <div class="box-body">

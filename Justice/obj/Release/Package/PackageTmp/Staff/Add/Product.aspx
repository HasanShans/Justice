                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group" runat="server" id="imagesForm">
                            ...
                            <div class="input-with-icon  right">
                                ...
                                <asp:RegularExpressionValidator runat="server" ErrorMessage="Zəhmət olmasa şəkil əlavə edin" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))+(.png|.PNG|.jpg|.JPG|.jpeg|.JPEG)$" ControlToValidate="img1p" Display="Dynamic"></asp:RegularExpressionValidator><br />
                                <asp:FileUpload ID="img2p" CssClass="form-control" runat="server" />
                                <asp:RegularExpressionValidator runat="server" ErrorMessage="Zəhmət olmasa şəkil əlavə edin" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))+(.png|.PNG|.jpg|.JPG|.jpeg|.JPEG)$" ControlToValidate="img2p" Display="Dynamic"></asp:RegularExpressionValidator><br />
                                <asp:FileUpload ID="img3p" CssClass="form-control" runat="server" />
                                <asp:RegularExpressionValidator runat="server" ErrorMessage="Zəhmət olmasa şəkil əlavə edin" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))+(.png|.PNG|.jpg|.JPG|.jpeg|.JPEG)$" ControlToValidate="img3p" Display="Dynamic"></asp:RegularExpressionValidator><br />
                                <asp:FileUpload ID="img4p" CssClass="form-control" runat="server" />
                                <asp:RegularExpressionValidator runat="server" ErrorMessage="Zəhmət olmasa şəkil əlavə edin" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))+(.png|.PNG|.jpg|.JPG|.jpeg|.JPEG)$" ControlToValidate="img4p" Display="Dynamic"></asp:RegularExpressionValidator><br />
                            </div>
                        </div>
                        <div class="form-group">
